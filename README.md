...
Το 3ο εργαστήριο βοήθησε να αποκτήσουμε μια πιο σφαιρική αντιληψη πάνω στη σχεδίαση μιας αρχιτεκτονικής, καθως πλέον δεν μετρούσαμε για τη λήψη της αποφασης μόνο την απόδοση και το κόστος αλλά και αλλους παραγοντες που αφορούν την ενεργειακή αποδοτικότητα. Αν εξαιρέσουμε τα πρακτικά προβλήματα στήν εκτέλεση των προσομοιώσεων στο McPAT, καθ η τρίτη εργασία βοήθησε σε συνδυασμό με την δεύτερη να κατανοήσουμε τις δυσκολίες που μπορεί υπάρξουν στη σύγκριση διαφόρων αρχιτεκτονικών και κατ’ επέκταση στη τελική επιλογή.
